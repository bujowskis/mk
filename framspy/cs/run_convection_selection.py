...
from framspy.evolalg.frams_base.experiment_frams_islands import ExperimentFramsIslands
...
def parseArguments():
    ...
    parser.add_argument("-n_pop", type=int, default=5, help="Number of populations in island model")
    parser.add_argument("-m_interv", type=int, default=10,
                        help="Interval of generations for migration between populations")
...
def main():
    ...
    experiment = ExperimentFramsIslands(
        frams_lib=framsLib,
        ...
        migration_interval=parsed_args.m_interv,
        number_of_populations=parsed_args.n_pop
    )
