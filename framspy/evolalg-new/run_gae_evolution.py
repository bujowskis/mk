...
from .gae_experiments.magnifier_evolution import MagnifierEvolution
from .gae_experiments.ae_evolalg import AE_evolalg
...
def parseArguments():
    ...
    parser.add_argument('-path_ae', type=str, required=True, help='Path to ae_file.')
    parser.add_argument('-train_set_size', type=int, default=10000, help='Number of individuals used to training ae')
...
def main():
    ...
    autoencoder = AE_evolalg(parsed_args.path_ae)
    ...
    experiment = MagnifierEvolution(frams_lib=framsLib,
                           ...
                           train_set_size=parsed_args.train_set_size,
