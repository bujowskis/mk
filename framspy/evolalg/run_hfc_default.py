...
def main():
    ...
    hof, stats, df = experiment.evolve(
        hof_savefile=f'/home/frams/obliczenia/fitdiversity/framspy/HoF/numerical_CSvsHFC/hfc/HoF-hfc-{function_str}-{dimension}-{repetition}-{fraction}-{migration_interval}-{number_of_populations}-{subpopsize}-{pmut}-{pxov}-{tournament_size}.gen',
    ...
    df.to_csv(f'/home/frams/obliczenia/fitdiversity/framspy/results/numerical_CSvsHFC/hfc/numerical_CSvsHFC-hfc-{function_str}-{dimension}-{repetition}-{fraction}-{migration_interval}-{number_of_populations}-{subpopsize}-{pmut}-{pxov}-{tournament_size}.csv')
